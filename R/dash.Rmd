...
params:
  filename : "~/Desktop/darts/2021-04-25_summary.Rdata"
  set_title: "summary"
output: 
...
Oggi hai giocato `r res$number_of_legs` legs, usando `r sum(res$number_of_darts)` darts. 
...
dove <- data.frame(
  ...
  xmin = c(0, rep(c(0, 7, 9, 2, 18, 4, 11, 13, 16, 5, 14, 17, 3, 15, 6, 12, 8, 1, 10, 19), 4), rep(0, 2)),
  xmax = c(20, rep(c(1, 8, 10, 3, 19, 5, 12, 14, 17, 6, 15, 18, 4, 16, 7, 13, 9, 2, 11, 20), 4), rep(20, 2)),
  ymin = c(170, rep(162, 20), rep(107, 20), rep(99, 20), rep(16, 20), 12.7/2, 0),
  ymax = c(205, rep(170, 20), rep(162, 20), rep(107, 20), rep(99, 20), 16, 12.7/2)
)
...
ggplot(df) +
  ...
  geom_point(data = dfdove, aes(x = x, y = y), color = "blue", size = 1, shape = 4) +
  theme_void()
